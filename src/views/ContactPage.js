                            ...
                            <div className="contact-form">
                                <div className="field">
                                    ...
                                    <div className="control">
                                        <input className="input is-medium has-background-white has-text-dark-90" type="text"/>
                                    </div>
                                </div>
                                <div className="field">
                                ...
                                <div className="field">
                                    ...
                                    <div className="control">
                                        <textarea className="textarea is-medium has-background-white has-text-dark-90"></textarea>
                                    </div>
                                </div>
