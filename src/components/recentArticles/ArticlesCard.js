            ...
            <div>
                <div className={`article-card ${isHovered ? 'hovered' : ''}`}
                    ...
                    <div className="overlay is-display-flex is-align-items-center has-text-centered">
                        <a href={`/news/${id}`} className="button has-background-transparent is-bordered has-text-warning mx-6 my-6">
                ...
                <div>
                    <div className="info-blog has-text-centered">
                        ...
                        <h4><a href={`/news/${id}`} className="title is-4 has-text-black pr-4 pl-4 has-text-centered">{title}</a></h4>
